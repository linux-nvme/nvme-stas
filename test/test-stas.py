...
class TestExcluded(unittest.TestCase):
    ...
    def test_a_mapped_address_matches_its_ipv4_spelling(self):
        ...
        An exclusion list entry naming 1.2.3.4 means that controller."""
        excluded = [{'transport': 'tcp', 'traddr': '1.2.3.4'}]
...
# ==============================================================================
# stas.remove_excluded() and stas.excluded() are exercised against a real
# libnvme exclusion list in test/test-exclusions.py's TestLibnvmeExclusions.
