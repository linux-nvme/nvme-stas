...
This ensures consistency with other NVMe tools like `nvme-cli` and `libnvme`. Alternative values, and the optional Host symbolic name, can be set in the `[Host]` section of `/etc/nvme/nvme-stas.conf`.
